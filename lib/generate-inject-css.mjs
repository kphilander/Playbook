...
lines.push(`  --pb-gradient-bar: linear-gradient(90deg, ${palette.accent || '#FF6B35'}, ${palette.secondary || '#00D4AA'});`);
...
const logoBook = readableOn(palette.secondary || '#00D4AA', palette.primary || '#1B2838', 6);
...
lines.push(`  --pb-logo-book: ${logoBook};`);
