...
| File | Purpose |
|------|---------|
| [ai-guide.md](ai-guide.md) | Find, read, adapt, and cite the public library with an AI assistant; no installation required |
...
- Not a clinical research protocol
- Not a harm-measurement tool
- Not a replacement for quantitative KPIs (it complements them)

See [Chapter 8 -- Governance](../brand-book/08-governance.md#what-not-to-measure) for what {{PROGRAM_NAME}} does and does not measure.
