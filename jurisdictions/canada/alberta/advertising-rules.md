...
title: "Alberta -- Advertising Rules"
pillar: [open]
tier: 1
...
adaptation_notes: |
  Advertising rules layer provincial (AGLC) and national (CGA Code)
  requirements. Alberta's framework is broadly aligned with Ontario's
...
| Section | Description |
|---|---|
| [Alberta's advertising framework](#albertas-advertising-framework) | Multi-layer structure |
| [AGLC iGaming advertising standards](#aglc-igaming-advertising-standards) | Key requirements |
...
Alberta gambling advertising is governed by two overlapping layers:
...
| **RG Check** | Mandatory for all iGaming operators | Not mandatory | Not applicable (BCLC monopoly) |
...
| **Truthfulness** | Advertising must be truthful and not mislead |
| **Minor protection** | Must not be based on themes intended to appeal to minors |
...
Unlike Ontario's outright ban on public sport betting inducement advertising, Alberta takes a **consent-based approach**:
...
- Inducement advertising is permitted in public channels (TV, radio, digital display) as long as it includes responsible gambling messaging and does not target prohibited groups
- Direct marketing of inducements requires documented opt-in consent
- Alberta's rules reward strong evidence trails -- operators should maintain detailed records of marketing policies and consent states

---

## CGA Code for Responsible Gaming Advertising

The **CGA Code for Responsible Gaming Advertising** (January 2026), administered by Ad Standards Canada, applies nationally and overlays provincial requirements.
...
The following content types are prohibited in Alberta gambling advertising:

1. **Minor-targeting content** -- themes, characters, or placements intended to appeal to persons under 18
2. **Athlete endorsements** -- except when exclusively advocating for responsible gaming practices
...
10. **Unsolicited inducement marketing** -- inducement communications without documented opt-in consent

---

## Required disclosures

All gambling advertising in Alberta must include:

| Disclosure | Requirement | Source |
|---|---|---|
| **Responsible gambling message** | Must appear in all advertising and marketing materials | AGLC Standards |
| **Helpline reference** | Responsible gambling message with helpline information | CGA Code |
| **Age notice** | 18+ | AGLC Standards |
| **T&Cs for promotions** | Clear terms and conditions for bonus offers | CGA Code |
| **Inducement conditions** | All material conditions disclosed for inducement communications | AGLC Standards |

---

## {{PROGRAM_NAME}} content compliance matrix

Assessment of {{PROGRAM_NAME}} collateral templates against Alberta advertising requirements:

| Template | Alberta compliant? | Required changes |
|---|---|---|
| **Core messages** (74) | Yes | Add Alberta helpline number where helpline token appears |
| **Myth-busters** (18) | Yes | None -- educational content, not advertising |
| **CTAs** (50) | Yes | Ensure no misleading claims about outcomes |
| **HTP cards** | Yes | None -- educational content |
| **Poster templates** | Partial | Add responsible gambling message and 18+ age notice |
| **Email templates** | Partial | Add Alberta helpline, responsible gambling message, 18+ |
| **Social media cards** | Partial | Add responsible gambling message; verify no minor-appealing content |
| **Venue signage** | Partial | Add Alberta helpline, 18+ age notice |
| **Video end cards** | Partial | Add Alberta helpline (3-second minimum recommended) |

### Quick fix for "Partial" items

All "Partial" items require the same three changes:
1. Set `{{HELPLINE_NUMBER}}` to `1-866-332-2322`
2. Set `{{MIN_AGE}}` to `18`
