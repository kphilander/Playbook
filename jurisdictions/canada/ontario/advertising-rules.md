...
title: "Ontario — Advertising Rules"
pillar: [open]
tier: 1
...
adaptation_notes: |
  Advertising rules layer provincial (AGCO) and national (CGA Code)
  requirements. Ontario's sport betting inducement ban is the most
  distinctive restriction. On-brand disclosure examples need cultural
  adaptation for non-North-American markets.
last_updated: 2026-06-08
---

# Ontario — Advertising Rules
...
| Section | Description |
|---|---|
| [Ontario's advertising framework](#ontarios-advertising-framework) | Multi-layer structure |
| [AGCO Standards — iGaming](#agco-standards--igaming) | Standards 2.03–2.07 |
| [AGCO Standards — Gaming and Lottery](#agco-standards--gaming-and-lottery) | Standards 2.1–2.2.3 |
| [Sport betting inducement ban](#sport-betting-inducement-ban) | Ontario's most distinctive restriction |
...
**Public advertising of gambling inducements, bonuses, and credits related to sport and event betting is prohibited** — in force since the regulated market launched on **April 4, 2022**. This includes targeted advertising and algorithm-based ads.
...
| Email | Yes | Active player consent (opt-in) |
...
{{PROGRAM_NAME}} content is primarily **educational/informational** (how games work, odds literacy, myth-busting) rather than promotional (inducements, bonuses). This means most {{PROGRAM_NAME}} content is **not affected** by the inducement ban. However:

- If {{PROGRAM_NAME}} content references or appears alongside bonus/inducement messaging on an operator's platform, the educational content itself is not prohibited
- {{PROGRAM_NAME}} social media content should never reference specific operator bonuses or inducements
- {{PROGRAM_NAME}} email content is exempt from the ban (it's educational, not inducement advertising), but operators should keep educational and promotional emails clearly distinct
...
| **Email** | ConnexOntario in footer. Inducement emails only to opted-in players (Std 2.07). |
...
| Rule | Details |
|---|---|
| **Self-excluded players** | Must be removed from all marketing lists within 24 hours (Std 2.03/2.07) — includes persons on the [BetGuard](README.md#self-exclusion) centralized registry, checked in real time |
