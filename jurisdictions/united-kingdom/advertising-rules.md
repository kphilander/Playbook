...
title: "United Kingdom — Advertising Rules"
pillar: [open]
tier: 1
...
adaptation_notes: |
  UK advertising rules are the most complex globally, layering LCCP
...
| Section | Description |
|---|---|
| [UK's advertising framework](#uks-advertising-framework) | Four-layer structure |
...
| [Required disclosures](#required-disclosures) | What must appear in all advertising |
| [Rewards and bonuses (SR 5.1.1)](#rewards-and-bonuses-sr-511) | Incentive advertising rules |
| [{{PROGRAM_NAME}} content compliance matrix](#programname-content-compliance-matrix) | Map {{PROGRAM_NAME}} content to UK rules |
...
**Impact on {{PROGRAM_NAME}}**: If {{PROGRAM_NAME}} content is used by any UK-licensed operator (wherever based), it must comply with the CAP Code in full. This includes social media posts, content marketing, and organic digital content.
...
How {{PROGRAM_NAME}} content types map to UK advertising rules:
...
For each piece of {{PROGRAM_NAME}} content deployed in the UK:

1. Check against the [prohibited content](#prohibited-content) list
2. Verify [required disclosures](#required-disclosures) are present
...
*Cross-references: [UK compliance module](README.md) | [`_brand.yml`](../../_brand.yml) | [UK config overrides](_brand-uk.yml) | [CAP Code Section 16](https://www.asa.org.uk/type/non_broadcast/code_section/16.html) | [BCAP Code Section 17](https://www.asa.org.uk/type/broadcast/code_section/17.html) | [LCCP](https://www.gamblingcommission.gov.uk/lccp) | [Governance](../../brand-book/08-governance.md)*
