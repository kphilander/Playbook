...
title: "New Jersey — Advertising Rules"
pillar: [open]
tier: 1
...
### What "no inducement to continue" means for {{PROGRAM_NAME}}
...
1. **"Bet With Your Head, Not Over It"** (or comparable language)
2. **1-800-GAMBLER** (prominently displayed, legible -- not microscopic font)
...
Which {{PROGRAM_NAME}} templates comply with NJ advertising rules as-is, and which need adaptation:
...
- Any {{PROGRAM_NAME}} template used in a commercial/promotional context must include 1-800-GAMBLER and "Bet With Your Head, Not Over It"
...
*Cross-references: [New Jersey Compliance Module](README.md) | [Application Guidelines](../../../brand-book/07-application-guidelines.md) | [Governance](../../../brand-book/08-governance.md) | [US Overview](../README.md)*
