...
title: "Pennsylvania -- Compliance Module"
pillar: [open]
tier: 1
tone: [confident-informative]
reading_level: grade-9-12
game_type: [slots, blackjack, roulette, sports-betting, video-poker, poker, online-casino]
audience: [general]
channel: [blog, in-app]
cultural_profile:
  voice: peer
...
adaptation_notes: |
  Pennsylvania module is written for the US market (peer/individual/irreverent/
...
| Section | Description |
|---|---|
| [Regulatory authority](#regulatory-authority) | PGCB structure and key contacts |
...
| **Responsible play website** | [responsibleplay.pa.gov](https://responsibleplay.pa.gov/) |

### Structure

The PGCB is an independent state agency with seven commissioners. Unlike Nevada's two-tier model, the PGCB combines investigative, decision-making, and enforcement functions in a single body. Key divisions relevant to {{PROGRAM_NAME}}:

| Division | Relevance to {{PROGRAM_NAME}} |
|---|---|
| **OCPG** (Office of Compulsive and Problem Gambling) | Approves signage messages, oversees self-exclusion programs, can order ad discontinuation |
| **Bureau of Gaming Operations** | Reviews promotions and tournament filings |
| **Office of Sports Wagering** | Reviews sports wagering contest and tournament filings |

### Primary sources

| Document | URL | Relevance |
|---|---|---|
| 58 Pa. Code Chapter 501a | [pacodeandbulletin.gov -- 501a](https://www.pacodeandbulletin.gov/Display/pacode?file=/secure/pacode/data/058/chapter501a/chap501atoc.html) | Compulsive and problem gambling requirements (land-based) |
| 58 Pa. Code Chapter 503a | [pacodeandbulletin.gov -- 503a](https://www.pacodeandbulletin.gov/Display/pacode?file=/secure/pacode/data/058/chapter503a/chap503atoc.html) | Casino self-exclusion |
| 58 Pa. Code Chapter 813a | [pacodeandbulletin.gov -- 813a](https://www.pacodeandbulletin.gov/Display/pacode?file=/secure/pacode/data/058/chapter813a/chap813atoc.html) | Interactive gaming advertisements, promotions, tournaments |
...
| Requirement | Value |
|---|---|
| **Minimum gambling age** | 21+ (all gambling products) |
| **Legal framework** | State-licensed operators under 4 Pa.C.S. |
| **Online gambling** | Online casino (iGaming) legal since 2019; online poker legal; sports betting legal since 2018 |
| **Lottery** | Yes (Pennsylvania Lottery, separate from PGCB jurisdiction) |

### Permitted products

| Product | Vertical | Legal status | Regulator | Notes |
|---|---|---|---|---|
| Casino (slots, table games) | Land-based | Legal | PGCB | 16+ casinos: Category 1 (racetrack casinos), Category 2 (stand-alone), Category 3 (resort), Category 4 (mini-casinos) |
...
Pennsylvania uses a **category-based licensing system** for casinos:

| Category | Description |
|---|---|
| **Category 1** | Racetrack casinos (slots + table games at horse racing tracks) |
| **Category 2** | Stand-alone casinos |
| **Category 3** | Resort casinos (at qualified resorts) |
| **Category 4** | Mini-casinos (satellite facilities, max 750 slots + 30 table games) |

Interactive gaming and sports wagering certificates are issued to holders of Category 1-3 licenses, who may partner with operators.
...
Pennsylvania requires the **1-800-GAMBLER** helpline number in all gambling advertisements and on interactive gaming platforms.
...
| **Hours** | 24/7 |
| **Cost** | Free |
| **Regulatory reference** | 58 Pa. Code 501a.7(d); 814a.1 |

### Council on Compulsive Gambling of Pennsylvania

| Field | Value |
|---|---|
| **Organization** | Council on Compulsive Gambling of Pennsylvania (CCGP) |
| **Role** | State-level education, advocacy, and referral (nonprofit) |
| **Regulatory reference** | 58 Pa. Code 814a.1 (iGaming platforms must link to CCGP website) |

### Pennsylvania Department of Drug and Alcohol Programs (DDAP)

| Field | Value |
|---|---|
| **Role** | State agency administering gambling addiction treatment providers |
| **Regulatory reference** | 58 Pa. Code 501a.7(d) (ads must include DDAP helpline); 814a.1 (iGaming must link to DDAP provider list) |

### Display rules

#### Land-based display (501a.5; 501a.7)

- **Minimum 20 signs** with OCPG-approved gambling assistance message
- Signs required **within 50 feet** of each entrance and exit
- Signs required **above or below cash dispensing openings** on ATMs, voucher/coupon redemption machines, and other cash-dispensing equipment
- Message text must be approved by the OCPG Director

#### Interactive display (814a.1)

Verbatim message required on login/logout screens:
...
> Need to talk? Free, confidential help is one call away -- 24/7. Call **1-800-GAMBLER** or visit [responsibleplay.pa.gov](https://responsibleplay.pa.gov/).
...
|---|---|---|---|
| iGaming helpline | "IF YOU OR SOMEONE YOU KNOW HAS A GAMBLING PROBLEM, HELP IS AVAILABLE, CALL 1-800-GAMBLER" | Login and logout screens of all interactive gaming platforms | 58 Pa. Code 814a.1 |
...
**Verbatim statement** (iGaming login/logout -- cannot be modified):
> "IF YOU OR SOMEONE YOU KNOW HAS A GAMBLING PROBLEM, HELP IS AVAILABLE, CALL 1-800-GAMBLER"

**{{PROGRAM_NAME}} on-brand version** (surrounding context):
> *Welcome back to [Operator Name].* IF YOU OR SOMEONE YOU KNOW HAS A GAMBLING PROBLEM, HELP IS AVAILABLE, CALL 1-800-GAMBLER. *Your dashboard, your rules -- set your limits before you play.*

**Rules for on-brand integration:**
1. Verbatim statements appear word-for-word -- never paraphrase legally required language
2. Obligation-based requirements (signage, ads) can use {{PROGRAM_NAME}} voice as long as the OCPG-approved message and 1-800-GAMBLER appear
...
### Advertising rules summary

| Rule | Requirement | Verticals | Source |
|---|---|---|---|
| Gambling assistance message | All ads must include helpline (1-800-GAMBLER) with DDAP number | All | 58 Pa. Code 501a.7(d) |
| No false information | Ads must not contain false or misleading information | All | 58 Pa. Code 501a.7 |
...
|---|---|---|
| TV and radio | Must be co-branded (certificate holder + operator) | 58 Pa. Code 813a.2 |
| Direct mail / email / text | Must be co-branded when directed to PA residents | 58 Pa. Code 813a.2 |
| Billboards (in-state) | Must be co-branded | 58 Pa. Code 813a.2 |
| Print publications (PA-based) | Must be co-branded | 58 Pa. Code 813a.2 |

### Prohibited content

- Indecent or offensive graphics or audio
- Content that obscures or obstructs active gameplay
- Content conflicting with game rules or stated conditions
- Targeting excluded players
- Capping or limiting winnings after promotion terms are met (iGaming)
- Floor-level solicitation by hired individuals

### Required disclosures

- 1-800-GAMBLER helpline number with prescribed font sizing
- All conditions and limiting factors associated with the advertisement
- iGaming: both certificate holder and operator names/logos (co-branding)
...
| Field | Value |
|---|---|
| **Program name** | Casino Self-Exclusion |
| **Duration options** | 1 year, 5 years, or lifetime |
| **Scope** | Statewide -- all licensed facilities and Board-approved gaming locations |
| **Enrollment method** | Electronic (PGCB website), or in-person at PGCB offices (Harrisburg or regional) or licensed facilities |
| **Contact** | OCPG at (717) 346-8300 or problemgambling@pa.gov |
| **Marketing cessation** | Casinos must ensure excluded persons do not receive junket solicitations, targeted mailings, telemarketing promotions, player club materials, or other promotional materials |
| **Winnings forfeiture** | Winnings during exclusion remitted to the Board for compulsive and problem gambling programs |
| **Reinstatement (1/5 year)** | Request removal after period expires; Board removes within 5 business days; 7-business-day cooling-off before gaming floor access |
| **Reinstatement (lifetime)** | Petition after 10 years with problem gambling assessment completion and treatment provider verification |
| **Source** | [58 Pa. Code 503a](https://www.pacodeandbulletin.gov/Display/pacode?file=/secure/pacode/data/058/chapter503a/chap503atoc.html) |

### Interactive gaming self-exclusion (58 Pa. Code Chapter 815a)

| Field | Value |
|---|---|
| **Program name** | Interactive Gaming Self-Exclusion |
| **Duration options** | 1 year, 5 years, or lifetime |
| **Scope** | All interactive gaming and sports wagering in Pennsylvania |
| **Account action** | Operators must refuse wagers, deny gaming privileges, and stop all marketing |
| **Marketing cessation** | No targeted mailings, telemarketing promotions, player club materials, or promotional materials relating to interactive gaming |
| **Winnings forfeiture** | Winnings remitted to the Board for compulsive and problem gambling programs |
| **Reinstatement (1/5 year)** | Automatic removal upon period completion |
...
|---|---|---|---|
| Problem gambling information posting | Yes | Minimum 20 signs with OCPG-approved message; within 50 feet of entrances/exits and at ATMs | 58 Pa. Code 501a.5 |
| Helpline display | Yes | 1-800-GAMBLER on signage and all advertising | 58 Pa. Code 501a.5; 501a.7(d) |
| Patron education materials | Yes | Printed material on compulsive gambling, self-exclusion, and treatment services | 58 Pa. Code 501a.2 |
| Employee training | Yes | All patron-facing employees; orientation + annual reinforcement; documented | 58 Pa. Code 501a.3 |
| Self-exclusion | Yes | Statewide casino self-exclusion; 1/5/lifetime options | 58 Pa. Code 503a |
| Treatment referral procedures | Yes | Procedures for providing treatment service information to patrons and family members | 58 Pa. Code 501a.2 |
| Reporting | Yes | Annual reports on program effectiveness, materials distributed, self-exclusion statistics | 58 Pa. Code 501a.4 |

### {{PROGRAM_NAME}} tool messaging -- land-based

| Tool | {{PROGRAM_NAME}} copy | Context |
|---|---|---|
| Venue signage | "[Operator] is committed to fair play. If gambling stops being fun, free help is available 24/7: 1-800-GAMBLER." | 58 Pa. Code 501a.5 (subject to OCPG approval) |
| Self-exclusion info | "Want to take a break? Pennsylvania offers a statewide self-exclusion program. Ask any team member or visit gamingcontrolboard.pa.gov." | 58 Pa. Code 503a |
| Patron brochure | "Your guide to playing smart -- odds, tools, and support. Because knowing how it works is part of the fun." | 58 Pa. Code 501a.2 |

---

## Player protection -- interactive

### Required tools and obligations (58 Pa. Code 814a.1; 814a.2)

| Tool / Obligation | Required? | Details | Source |
|---|---|---|---|
| Deposit limits | Yes | Daily, weekly, and monthly caps on deposit amounts | 58 Pa. Code 814a.2 |
| Loss limits | Yes | Daily, weekly, and monthly; play stops when limit reached | 58 Pa. Code 814a.2 |
| Single wager cap | Yes | Maximum amount on any single wager | 58 Pa. Code 814a.2 |
| Session / play-time limits | Yes | Daily time limits; player may finish current round when limit expires | 58 Pa. Code 814a.2 |
| Peer-to-peer table limits | Yes | Maximum buy-in for peer-to-peer games | 58 Pa. Code 814a.2 |
| Temporary account suspension | Yes | Minimum 72-hour suspension; player-selected duration; fund withdrawal permitted during suspension | 58 Pa. Code 814a.2 |
| Hourly pop-up notifications | Yes | Must display time elapsed and money wagered since login every hour; 15/30-minute options available | 58 Pa. Code 814a.1 |
| Session time display | Yes | Current local time and elapsed session duration visible | 58 Pa. Code 814a.1 |
| Previous login display | Yes | Previous login date/time shown upon account access | 58 Pa. Code 814a.1 |
| Responsible gambling message | Yes | Verbatim helpline message on login/logout screens | 58 Pa. Code 814a.1 |
| Player protection page | Yes | Links to CCGP, DDAP provider list, and OCPG webpage | 58 Pa. Code 814a.1 |
| Self-exclusion | Yes | Interactive gaming self-exclusion; 1/5/lifetime options | 58 Pa. Code 815a |
| Marketing cessation (suspended) | Yes | No gaming communications to suspended accounts | 58 Pa. Code 814a.1 |

### Limit modification rules

| Change type | Effective when |
|---|---|
| Decrease (more restrictive) | Immediately |
| Increase (less restrictive) | After previous limit period expires + player reaffirmation |
| Changes during suspension | Not permitted (account must be active) |

### {{PROGRAM_NAME}} tool messaging -- interactive

| Tool | {{PROGRAM_NAME}} copy | Context |
|---|---|---|
| Deposit limits | "Set your deposit limit -- daily, weekly, or monthly. Your budget, your call. Takes 10 seconds." | 58 Pa. Code 814a.2 |
| Loss limits | "Set a loss limit -- no surprises at the end of a session. When you hit it, play pauses." | 58 Pa. Code 814a.2 |
...
|---|---|
| **Minimum age** | 21+ |
| **`_brand.yml` key** | `legal.minimum_gambling_age.united-states-pennsylvania` |
| **`{{MIN_AGE}}` token value** | 21 |
| **Statutory basis** | 4 Pa.C.S. 1207; 58 Pa. Code 513a |

### Land-based verification

| Requirement | Details | Source |
|---|---|---|
| **Method** | Government-issued photo identification | 58 Pa. Code 513a |
| **Enforcement** | Facilities must prevent minors from accessing gaming floors | 58 Pa. Code 513a |

### Interactive verification

| Requirement | Details | Source |
|---|---|---|
| **Registration requirements** | Date of birth, identity verification | 58 Pa. Code 814a |
| **Verification method** | Electronic identity verification | 58 Pa. Code 814a |
...
| Requirement | Value |
|---|---|
| **AML authority** | FinCEN (federal); PGCB (state oversight) |
| **KYC threshold** | CTR at $10,000+ (federal BSA requirement) |
| **Reporting requirements** | CTRs, SARs filed with FinCEN; Pennsylvania casinos are financial institutions under BSA |
| **Player-facing impact** | Identity verification at account creation (interactive); large transaction reporting |
...
|---|---|---|---|---|
| **Digital** | Website | Both | Add 1-800-GAMBLER; add CCGP, DDAP, OCPG links on protection page | `{{HELPLINE_NUMBER}}` |
| **Digital** | Wagering account / app | Interactive | Verbatim login/logout message; deposit/loss/time limits; hourly pop-ups; session timer | `{{MANDATORY_STATEMENT}}` |
| **Digital** | Email templates | Both | 1-800-GAMBLER in footer; co-branding if iGaming | `{{HELPLINE_NUMBER}}` |
| **Digital** | Social media | Both | 1-800-GAMBLER; font size compliance | `{{HELPLINE_NUMBER}}` |
| **Print** | Brochure | Both | 1-800-GAMBLER; 2% font minimum | `{{HELPLINE_NUMBER}}` |
| **Print** | Rack card | Land-based | 1-800-GAMBLER; self-exclusion info; treatment resources | `{{HELPLINE_NUMBER}}` |
| **Print** | Table tent | Land-based | 1-800-GAMBLER; OCPG-approved message | `{{HELPLINE_NUMBER}}` |
| **Print** | Helpline card | Both | 1-800-GAMBLER; CCGP and DDAP references | `{{HELPLINE_NUMBER}}` |
| **Environmental** | Venue signage | Land-based | Minimum 20 signs; within 50ft of entrances/exits; at ATMs | `{{HELPLINE_NUMBER}}` |
| **Environmental** | Digital display | Land-based | 1-800-GAMBLER; OCPG-approved message | `{{HELPLINE_NUMBER}}` |
...
helplines:
  united-states:
    pennsylvania:
      ...
      label: "Pennsylvania Problem Gambling Helpline"
      hours: "24/7"
      state_resource: "Council on Compulsive Gambling of Pennsylvania (CCGP)"
      ocpg_contact: "(717) 346-8300"
      ocpg_email: "problemgambling@pa.gov"
      notes: "Pennsylvania uses 1-800-GAMBLER as required by 58 Pa. Code 501a.7(d) and 814a.1."

# --- LEGAL ---
legal:
  minimum_gambling_age:
    united-states-pennsylvania: 21

# --- MESSAGING ---
messaging:
  mandatory:
    united-states-pennsylvania-igaming: |
      IF YOU OR SOMEONE YOU KNOW HAS A GAMBLING PROBLEM,
      HELP IS AVAILABLE, CALL 1-800-GAMBLER
    # Venue signage: obligation-based (OCPG-approved text, no prescribed wording)
    # Advertising: standard-based (must include 1-800-GAMBLER with DDAP number)
```
...
Complete before launching {{PROGRAM_NAME}} in Pennsylvania.
...
### Messaging
- [ ] Verbatim iGaming statement displays word-for-word on login/logout screens
- [ ] Obligation-based signage requirements met with OCPG-approved text
...
- [ ] Print ads: 2% minimum or match majority font
- [ ] Billboards: 5% minimum
- [ ] Video/TV: 2% throughout or 8% end screen (3 seconds)
- [ ] Websites: match majority text or 2% for gaming-specific ads
- [ ] iGaming ads co-branded (certificate holder + operator equally)
- [ ] No prohibited content (offensive graphics, floor solicitation, etc.)
...
### Player protection -- land-based
- [ ] Minimum 20 signs posted with OCPG-approved message
- [ ] Signs within 50 feet of entrances/exits
- [ ] Signs at all ATMs and cash-dispensing machines
- [ ] Printed patron education materials available
- [ ] Employee training program implemented (orientation + annual reinforcement)
- [ ] Treatment referral procedures in place

### Player protection -- interactive
- [ ] Deposit limits (daily/weekly/monthly) implemented
- [ ] Loss limits (daily/weekly/monthly) implemented
- [ ] Single wager cap available
- [ ] Session/play-time limits implemented
- [ ] Temporary account suspension (minimum 72 hours) available
- [ ] Hourly pop-up notifications operational (time + money wagered)
- [ ] Session time and local time displayed
- [ ] Previous login date/time shown on access
