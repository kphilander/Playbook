...
| [Direct advertising requirements](#direct-advertising-requirements) | Opt-out, targeting, electronic mail |
...
| **Print** | Prevention message + helpline; conditions, odds, and material factors | Full disclosures in all print ads |
...
Assessment of which {{PROGRAM_NAME}} templates are Ohio-compliant as-is:
...
> Need a break? Time Out Ohio covers every casino, racino, and sportsbook in the state: **timeoutohio.com**
> Free, confidential support 24/7: **1-800-589-9966** | Text 4hope to 741741
...
*Cross-references: [Ohio compliance module](README.md) | [Nevada advertising rules](../nevada/advertising-rules.md) | [Messaging Framework -- Warning Statement Standards](../../../brand-book/05-messaging-framework.md#warning-statement-standards) | [Application Guidelines](../../../brand-book/07-application-guidelines.md)*
