...
title: "Macau SAR -- Compliance Module"
pillar: [open]
tier: 1
tone: [confident-informative]
reading_level: grade-9-12
game_type: [slots, baccarat, blackjack, roulette, sic-bo, fan-tan, poker]
audience: [general]
channel: [blog, in-app]
cultural_profile:
  voice: peer
...
presentation:
  odds_format: decimal
  currency: mop
  sports_culture: international
  language: zh-hant
verticals: [land-based]
regulatory_approach: hybrid
adaptation_status: base
adaptation_notes: |
  Macau module covers land-based casino operations only. Online gambling
  is strictly prohibited in Macau. Cultural adaptation required for
...
| Section | Description |
|---|---|
| [Regulatory authority](#regulatory-authority) | DICJ structure and reporting |
| [Legal requirements](#legal-requirements) | 21+, permitted products, legal framework |
| [Helpline](#helpline) | 24-hour Gambling Counseling Hotline |
| [Messaging requirements](#messaging-requirements) | Obligation-based RG messaging |
| [Advertising restrictions](#advertising-restrictions) | Advertisement Act restrictions |
| [Self-exclusion](#self-exclusion) | Self-exclusion and third-party exclusion (max 2 years) |
| [Player protection -- land-based](#player-protection----land-based) | Venue-specific protections |
| [Age verification](#age-verification) | 21+ casino entry requirements |
| [AML/KYC](#amlkyc) | DICJ AML requirements |
...
Macau operates under a **concession-based system**. The government grants concessions to operate casino games of fortune. As of January 2023, six concessions operate under 10-year contracts (2023-2032):

| Concessionaire | Key brands |
|---|---|
| SJM Resorts | Grand Lisboa, Lisboa Palace |
| Galaxy Entertainment | Galaxy Macau, StarWorld |
| Wynn Macau | Wynn Macau, Wynn Palace |
| Sands China | The Venetian Macao, The Londoner |
| Melco Resorts | City of Dreams, Studio City |
| MGM China | MGM Macau, MGM Cotai |
...
| Requirement | Value |
|---|---|
| **Minimum casino entry age** | 21+ (Law 10/2012; raised from 18 in November 2012) |
| **Minimum age (pari-mutuel/lottery)** | 18+ |
| **Legal framework** | Portuguese-derived civil law; Basic Law of Macau SAR |
| **Online gambling** | Strictly prohibited. Sole exception: sports lottery (football/basketball) operated by Macau Slot Co. under Chief Executive concession. |
| **Permitted products** | Land-based casino games of fortune (baccarat, blackjack, roulette, sic bo, fan tan, slots, poker, etc.); pari-mutuel (greyhound racing -- ended 2018); sports lottery (limited) |

### Permitted products table

| Product | Vertical | Legal status | Regulator | Notes |
|---|---|---|---|---|
| Casino games of fortune | Land-based | Legal (concession required) | DICJ | Six concessions, 10-year terms (2023-2032) |
...
| Field | Value |
|---|---|
| **Name** | 24-hour Gambling Counseling Hotline |
| **Phone** | (853) 2823 0101 |
| **Operated by** | Sheng Kung Hui Macau Social Service Coordination Office |
| **Hours** | 24/7 |
| **Languages** | Chinese (Cantonese, Mandarin), Portuguese, English |
| **Cost** | Free |

### Additional counseling organizations

| Organization | Phone | Notes |
|---|---|---|
| Yat On Responsible Gambling Counselling Centre | (853) 2821 0033 | Problem gambling counseling |
| Problem Gambling Prevention and Treatment Division (Resilience Centre) | (853) 2832 3998 | IAS-affiliated |
| Macao Industrial Evangelistic Fellowship | -- | Community support |
| Macao Gaming Employees Home | -- | Focused on gaming industry workers |
| DICJ direct line | (853) 2856 9262 | Regulatory inquiries, exclusion applications |
...
> "(853) 2823 0101 -- 24-hour Gambling Counseling Hotline"

**On-brand compliance** (the {{PROGRAM_NAME}} way):
> "Need to talk? The 24-hour Gambling Counseling Hotline is here for you: (853) 2823 0101. Free, confidential, any time."
...
Macau does not prescribe specific verbatim statements. Requirements are obligation-based: concessionaires must provide responsible gambling information but the exact wording is not mandated. This gives operators flexibility to use {{PROGRAM_NAME}} messaging.
...
Macau's obligation-based approach means operators have full flexibility to use {{PROGRAM_NAME}} messaging:

**Generic operator approach:**
> "If you think you have a gambling problem, call (853) 2823 0101."

**{{PROGRAM_NAME}} on-brand approach:**
> "Gambling should be fun, not stressful. If it stops being entertaining, the 24-hour Counseling Hotline is one call away: (853) 2823 0101. Free. Confidential. No judgment."
...
|---|---|---|---|
| Game-as-message prohibition | Advertising of games of fortune is prohibited when the game itself is the main message | Land-based | Advertisement Act (Decree-Law 7/89/M) |
...
| Field | Value |
|---|---|
| **Program name** | Self-Exclusion and Third-Party Exclusion (managed by DICJ) |
| **Duration options** | Up to 2 years maximum |
...
| Field | Value |
|---|---|
| **Who can apply** | Spouse, parent, child, or sibling (within second degree of kinship) |
| **Confirmation required** | Yes -- the excluded person must sign to confirm |
| **Scope** | All or specific casinos |
| **Duration** | Up to 2 years maximum |
| **Enrollment** | In-person at DICJ office |
| **Source** | [Law 10/2012; PS-1408b](https://www.gov.mo/en/services/ps-1408/ps-1408b/) |

### Penalties for violation

Entering or staying in casinos during the enforced exclusion period constitutes a **crime of disobedience**, punishable by:
- Up to 1-year imprisonment, OR
- A fine of 120 days

### Off-duty casino employee ban

Under the 2018 amendment (Law 17/2018) to Law 10/2012, effective December 27, 2019:
- All casino employees (including non-gaming staff: cashiers, F&B, cleaners, surveillance) are banned from entering any casino when off duty
- The ban is year-round except the first three days of Chinese New Year
- Violation: fines up to MOP 10,000

### {{PROGRAM_NAME}} language mapping

| Context | {{PROGRAM_NAME}} term | Official term | When to use official term |
|---|---|---|---|
| Tier 1 (casual) | "Take a break" / "Step away" | Self-exclusion | Never in Tier 1 |
...
*Not applicable. Online gambling is prohibited in Macau.*
...
| **Minimum age (pari-mutuel/lottery)** | 18+ |
| **`_brand.yml` key** | `legal.minimum_gambling_age.macau` |
| **`{{MIN_AGE}}` token value** | 21 |
| **Statutory basis** | Law 10/2012 |

### Land-based verification

| Requirement | Details | Source |
|---|---|---|
| **Method** | ID check at casino entry | Law 10/2012 |
| **Acceptable ID** | Passport, Macau ID card (BIR) | Law 10/2012 |
| **Under-21 penalty** | Fine MOP 1,000-10,000 for the individual | Law 10/2012 |
| **Casino penalty** | Fine MOP 10,000-500,000 for non-compliance | Law 10/2012 |
...
| Requirement | Value |
|---|---|
| **AML authority** | DICJ (gaming sector); AMCM (Monetary Authority of Macao) |
| **Financial intelligence** | Office of Financial Intelligence (GIF) |
| **KYC threshold** | Customer due diligence required |
| **High-Value Transaction Report** | MOP 500,000 or more, filed within 24 hours |
| **Suspicious Transaction Report** | Within 2 working days to GIF |
| **Compliance requirement** | Designated compliance manager; daily transaction records |
| **International standard** | FATF 40 Recommendations via APG membership |
...
**On-brand:**
> "Quick ID check -- it keeps your account secure and is required for all players."

---

## Collateral adaptation

| Category | Collateral | Adaptation required | Token |
|---|---|---|---|
| **Environmental** | Venue signage | Chinese (traditional) + Portuguese. Helpline: (853) 2823 0101. Age: 21+ | `{{HELPLINE_NUMBER}}`, `{{MIN_AGE}}` |
| **Environmental** | ATM signage | Hotline on screensaver: (853) 2823 0101 | `{{HELPLINE_NUMBER}}` |
| **Environmental** | RG kiosk content | Align with DICJ/IAS/ISCG kiosk standards | -- |
| **Print** | Brochure | Chinese/Portuguese. RG messages mandatory in gaming pamphlets | `{{HELPLINE_NUMBER}}` |
| **Print** | Rack card | Chinese/Portuguese. 21+ age notice | `{{MIN_AGE}}` |
| **Print** | Table tent | Chinese/Portuguese. Helpline prominent | `{{HELPLINE_NUMBER}}` |
| **Print** | Helpline card | (853) 2823 0101; additional counseling contacts | `{{HELPLINE_NUMBER}}` |
| **Customer service** | Conversation scripts | Adapt for Cantonese/Mandarin/Portuguese. DICJ exclusion process | -- |
| **Customer service** | Staff FAQ | Add Macau-specific Q&As (exclusion, hotline, off-duty ban) | -- |
...
helplines:
  macau:
    number: "(853) 2823 0101"
    website: "https://www.dicj.gov.mo/web/en/responsible/responsible01/content.html"
    label: "24-hour Gambling Counseling Hotline"
    hours: "24/7"
    languages:
      - Chinese (Cantonese)
      - Chinese (Mandarin)
      - Portuguese
      - English
    notes: "Operated by Sheng Kung Hui Macau Social Service Coordination Office"
...
messaging:
  mandatory:
    macau-general: null  # No verbatim statement required; obligation-based approach
```
...
Complete before launching {{PROGRAM_NAME}} in Macau SAR.
...
### Advertising
- [ ] No advertising where game of fortune is the main message
- [ ] Marketing focuses on entertainment, tourism, hospitality
- [ ] No online gambling advertising of any kind
- [ ] No content targeting persons under 21
- [ ] RG messages in all gaming-related promotional materials
...
### Age verification
- [ ] ID verification at casino entry points
- [ ] Security staff trained on age verification procedures
- [ ] Penalty framework understood (MOP 10,000-500,000 for casino non-compliance)

### Content
- [ ] All collateral adapted for Chinese (traditional) and Portuguese
- [ ] Staff FAQ updated with Macau-specific Q&As
- [ ] Conversation scripts adapted for local languages
