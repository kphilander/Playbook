...
| **Logo** | {{PROGRAM_NAME}} wordmark, horizontal (B2) layout, reversed variant (white Play + emerald BOOK on navy bg), top-left. Min height 0.25" (print). Maintain 1x logo-height clear space on all sides. Below 0.25", use logomark only. See [logo system](../../brand-book/03-visual-identity.md#1-logo-system) |
