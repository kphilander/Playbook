...
| **Logo** | {{PROGRAM_NAME}} logomark, reversed variant (white wordmark on navy `#0F1923` footer bg). Min height 24px. Below 24px, use logomark only (no wordmark). Maintain 1x logo-height clear space. See [logo system](../../brand-book/03-visual-identity.md#1-logo-system) |
