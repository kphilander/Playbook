...
| Element | Content |
|---|---|
| **Logomark** | {{PROGRAM_NAME}} logomark, reversed variant (white Play + emerald BOOK on dark bg). Min height 24px. Maintain 1x logo-height clear space on all sides. Below 24px, use logomark only (no wordmark). See [logo system](../../brand-book/03-visual-identity.md#1-logo-system) |
