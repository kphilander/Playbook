...
const cards = [
  ...
  { html: 'poster-4a-know-your-game.ja.html', output: 'poster-4a-know-your-game.ja.png', w: 1848, h: 2448, selector: '.poster' },
  { html: 'poster-4b-no-fine-print.ja.html', output: 'poster-4b-no-fine-print.ja.png', w: 1848, h: 2448, selector: '.poster' },
  { html: 'poster-4c-game-iq.ja.html', output: 'poster-4c-game-iq.ja.png', w: 1848, h: 2448, selector: '.poster' },
  ...
  { html: 'email-welcome-7a.ja.html', output: 'email-welcome-7a.ja.png', w: 600, h: 1100, selector: '.email' },
  ...
  { html: 'app-banner-12d.ja.html', output: 'app-banner-12d.ja.png', w: 728, h: 90, selector: '.app-banner' },
  { html: 'push-notification-12e.ja.html', output: 'push-notification-12e.ja.png', w: 420, h: 120, selector: '.push-notification' },
  { html: 'withdrawal-confirm-12f.ja.html', output: 'withdrawal-confirm-12f.ja.png', w: 420, h: 812, selector: '.withdrawal-confirm' },
  ...
  { html: 'poster-4a-know-your-game.zh-CN.html', output: 'poster-4a-know-your-game.zh-CN.png', w: 1848, h: 2448, selector: '.poster' },
  { html: 'poster-4b-no-fine-print.zh-CN.html', output: 'poster-4b-no-fine-print.zh-CN.png', w: 1848, h: 2448, selector: '.poster' },
  ...
  { html: 'email-welcome-7a.zh-CN.html', output: 'email-welcome-7a.zh-CN.png', w: 600, h: 1100, selector: '.email' },
  ...
  { html: 'app-banner-12d.zh-CN.html', output: 'app-banner-12d.zh-CN.png', w: 728, h: 90, selector: '.app-banner' },
  { html: 'push-notification-12e.zh-CN.html', output: 'push-notification-12e.zh-CN.png', w: 420, h: 120, selector: '.push-notification' },
  { html: 'withdrawal-confirm-12f.zh-CN.html', output: 'withdrawal-confirm-12f.zh-CN.png', w: 420, h: 812, selector: '.withdrawal-confirm' },
  ...
  { html: 'poster-4a-know-your-game.ar.html', output: 'poster-4a-know-your-game.ar.png', w: 1848, h: 2448, selector: '.poster' },
  { html: 'poster-4b-no-fine-print.ar.html', output: 'poster-4b-no-fine-print.ar.png', w: 1848, h: 2448, selector: '.poster' },
  ...
  { html: 'email-welcome-7a.ar.html', output: 'email-welcome-7a.ar.png', w: 600, h: 1100, selector: '.email' },
  ...
  { html: 'app-banner-12d.ar.html', output: 'app-banner-12d.ar.png', w: 728, h: 90, selector: '.app-banner' },
  { html: 'push-notification-12e.ar.html', output: 'push-notification-12e.ar.png', w: 420, h: 120, selector: '.push-notification' },
  { html: 'withdrawal-confirm-12f.ar.html', output: 'withdrawal-confirm-12f.ar.png', w: 420, h: 812, selector: '.withdrawal-confirm' },
  { html: 'betslip-rg-12g.ar.html', output: 'betslip-rg-12g.ar.png', w: 420, h: 320, selector: '.betslip-rg' },
