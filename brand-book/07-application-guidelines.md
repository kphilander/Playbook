...
- {{PROGRAM_NAME}} logomark (or text identifier)
...
| **Facebook** | Longer educational posts, community content |
| **YouTube** | Educational videos, how-it-works explainers |
| **LinkedIn** | Industry-facing: program achievements, thought leadership |
...
When {{PROGRAM_NAME}} content appears alongside the operator's brand:
