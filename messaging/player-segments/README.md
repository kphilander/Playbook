...
| [Help-Seekers](help-seekers.md) | Players actively looking for support — self-exclusion, helplines, cooling-off periods |

## How to use these

Each profile adapts the core Playbook voice for its audience. When creating segment-specific content:

1. Start with the segment profile for tone and messaging priorities
2. Pull copy from [`core-messages.md`](../core-messages.md) and [`calls-to-action.md`](../calls-to-action.md)
3. Check [`stigma-free-language.md`](../stigma-free-language.md) — especially important for at-risk and help-seeker segments
