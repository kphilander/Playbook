...
> **Operator note**: Rules vary by table, casino, and jurisdiction (number of decks, dealer stand rules, doubling restrictions, surrender availability). Verify specific rules and house edge calculations for your products before deploying. All copy follows {{PROGRAM_NAME}} Tier 1 voice (default Playbook voice).
