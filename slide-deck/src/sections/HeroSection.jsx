  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
      ...
      <div className={`relative z-10 text-center transition-all duration-1000 ease-out
        ...
        {/* Tagline */}
        <p className={`font-body text-base sm:text-lg text-n500 mt-6 max-w-md mx-auto leading-relaxed
        ...
        <div className={`flex items-center justify-center gap-3 mt-8
          ...
          <span className="text-n700 text-xs">/</span>
      ...
      <div className={`absolute bottom-8 left-1/2 -translate-x-1/2
        ...
        <div className="flex flex-col items-center gap-2 text-n700">
