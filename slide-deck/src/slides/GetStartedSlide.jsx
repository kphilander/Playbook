...
export default function GetStartedSlide() {
  return (
    <div className="relative w-full h-full bg-navy flex flex-col items-center justify-center px-12 py-8">
      <AccentBar />
      ...
      {/* URL */}
      <p className="font-mono text-2xl font-bold text-teal mt-14">
